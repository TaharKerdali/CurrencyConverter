...
export class CurrencyConverterService {
	...
	getCurrencies(): Observable<HttpResponse<any>> {
		return this.http.get<any>('http://localhost:1982/api/list-currencies?apiKey=cf8647435b1fed31c28e', {
			observe: 'body',
			responseType: 'json'
		});
	}
	...
	getRate(currency: string): Observable<HttpResponse<any>> {
		return this.http.get<any>(`http://localhost:1982/api/currency-rate?currency=${currency}&apiKey=cf8647435b1fed31c28e`, {
			observe: 'body',
			responseType: 'json'
		});
	}
